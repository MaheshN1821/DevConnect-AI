    ...
    <main style={containerStyle}>
      ...
      <div
        style={{
          ...
          height: "40%",
          background:
            "radial-gradient(circle, rgba(168, 85, 247, 0.2), transparent 80%)",
        }}
      />
      <div
        style={{
          ...
          height: "40%",
          background:
            "radial-gradient(circle, rgba(236, 72, 153, 0.2), transparent 80%)",
        }}
      />
        ...
        <form style={formStyle} onSubmit={handleEmailSignup}>
          <div style={inputGroupStyle}>
            ...
            <div style={relativeStyle}>
              <label htmlFor="full-name" style={{ display: "none" }}>
                Full Name
              </label>
