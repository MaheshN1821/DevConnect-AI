...
export default function CodeReview() {
  ...
  const handleReview = async () => {
    ...
    try {
      ...
      if (data.success) {
        captureEvent(EVENTS.CODE_REVIEW_REQUESTED, {
          language: data.review?.language || "unknown",
        });
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      >
        ...
        >
          ...
          >
            <label style={{ fontWeight: "500", color: "#e5e7eb" }}>
              📝 Your Code
            </label>
            <button
          ...
          {!review ? (
            ...
            <div>
              ...
              <div style={{ textAlign: "center", marginBottom: "24px" }}>
                ...
                >
                  {getScoreEmoji(review.quality_score)}{" "}
                  {getScoreText(review.quality_score)}
                </div>
                <div
                  style={{
                    fontSize: "11px",
              ...
              >
                ...
                >
                  ...
                  >
                    {review.summary?.security_issues || 0}
                  </div>
                  <div style={{ fontSize: "11px", color: "#6b7280" }}>
                    Security
                  </div>
                ...
                >
                  ...
                  >
                    {review.summary?.performance_issues || 0}
                  </div>
                  <div style={{ fontSize: "11px", color: "#6b7280" }}>
                    Performance
                  </div>
                  ...
                  {review.issues.map((issue, idx) => (
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: "8px",
                        marginBottom: "8px",
                        borderLeft: `3px solid ${issue.severity === "Critical" ? "#ef4444" : issue.severity === "High" ? "#f97316" : "#eab308"}`,
                      }}
                    >
                      <div
                        style={{
